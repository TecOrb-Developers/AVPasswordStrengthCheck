...
@IBDesignable
public class AVProgressBar: UIView {
    ...
    public var labelPosition: AVProgressBarLabelPosition = AVProgressBarLabelPosition.left {
        didSet {
            self.setNeedsLayout()
        }
    }
    ...
    public var labelPositionInt: Int = 0 {
        didSet {
            let enumPosition = AVProgressBarLabelPosition(rawValue: labelPositionInt)
    ...
    public var orientation: AVProgressBarOrientation = AVProgressBarOrientation.horizontal {
        didSet {
            self.setNeedsLayout()
        }
    }
    ...
    public var orientationInt: Int = 0 {
        didSet {
            let enumOrientation = AVProgressBarOrientation(rawValue: orientationInt)
    ...
    public var direction: AVProgressBarDirection = AVProgressBarDirection.clockwise {
        didSet {
            setNeedsLayout()
        }
    }
    ...
    public var directionInt: Int = 0 {
        didSet {
            let enumDirection = AVProgressBarDirection(rawValue: directionInt)
    ...
    public var cornerType: AVProgressBarCornerType = AVProgressBarCornerType.rounded {
        didSet {
            self.setNeedsLayout()
        }
    }
    ...
    @IBInspectable
    public var cornerTypeInt: Int = AVProgressBarCornerType.rounded.rawValue {
        didSet {
            let enumCornerType = AVProgressBarCornerType(rawValue: cornerTypeInt)
